...
<div class="slideshow-container" align="center">
  ...
  <div class="mySlides fade">
    ...
    <img src="fotos/senn25.png" style="width:20%">
  <div class="text"></div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext"></div>
    <img src="fotos/krk.png" style="width:25%">
  <div class="text"></div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext"></div>
      <img src="fotos/xzz.png" style="width:35%">
  <div class="text"></div>
  </div>
  ...
  <div class="mySlides fade">
    <div class="numbertext"></div>
      ...
      <img src="fotos/cdjtresmil.png" style="width:35%">
  <div class="text"></div>
  </div>
...
<div class="jumbotron" style="background-image: url(fotos/dj2.jpg); background-size: cover;">
   <div class="container for-about text-center">
    <div class="espaco">
   <h2 style="color: white;">Queres tornar-te DJ ou Produtor(a)? 
    <p>Temos os cursos ideais para ti!</p>
   <a class="btn btn-lg btn-primary" href="cursos.php">Cursos</a>
  </div>
   </div>
</div>
