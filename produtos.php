...
<br>
 ...
 <?php
            ...
            $stm = $con->prepare ('SELECT * FROM produtos WHERE idsubcat= ?');
            $stm->bind_param('i',$idmenu);
            $stm->execute();
            $res=$stm->get_result();
...
<div class="col-md-3 col-sm-6">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#"> <?php echo $resultado1['marca']?></a>
                </h4>
                 <h6><b> <?php echo $resultado1['modelo']?></b></h6>
                <h5><?php echo $resultado1['preco']?>€</h5>
              </div>
              <a href="produtosshow.php?produto=<?php echo $resultado1['idproduto']?>" target="blank" class="btn btn-primary">Saber Mais</a>
